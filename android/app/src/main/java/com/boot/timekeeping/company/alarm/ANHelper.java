...
public class ANHelper {
    ...
    public void sendNotification(Bundle bundle) {
        try {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
                ...
                notificationBuilder.setFullScreenIntent(resultPendingIntent, true);
            ...
            if (!bundle.containsKey("vibrate") || bundle.getBoolean("vibrate")) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    vibrator.vibrate(VibrationEffect.createOneShot(vibration, VibrationEffect.DEFAULT_AMPLITUDE));
                } else {
    ...
    public void scheduleAlarm(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            getAlarmManager().setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, fd, pendingIntent);
            getAlarmManager().setAlarmClock(new AlarmManager.AlarmClockInfo(fd, pendingIntent), pendingIntent);
