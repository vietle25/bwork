...
//    NSURL *fileURL =[[NSURL alloc] initFileURLWithPath:soundFilePath];
    NSString *thePath=[[NSBundle mainBundle] pathForResource:@"Constellation" ofType:@"mp3"];
    NSURL *theUrl=[NSURL fileURLWithPath:thePath];
    player = [[AVPlayer alloc]initWithURL:theUrl];
    [player play];
}
...
//        }
        ...
        if(musicUri == nil) {
            ...
            NSString *thePath=[[NSBundle mainBundle] pathForResource:@"Constellation" ofType:@"mp3"];
            NSURL *from=[NSURL fileURLWithPath:thePath];
...
//            NSURL *from = [NSURL fileURLWithPath:@"/Library/Ringtones/Constellation.m4r"];
        ...
        if (intervalSeconds > 0) {
            NSTimeInterval _interval=[triggerTime doubleValue];
...
//            UNNotificationRequest *request1 = [UNNotificationRequest requestWithIdentifier:[triggerTime stringByAppendingString: @"1"] content:content trigger:trigger1];
//            UNNotificationRequest *request2 = [UNNotificationRequest requestWithIdentifier:[triggerTime stringByAppendingString: @"1"] content:content trigger:trigger2];
