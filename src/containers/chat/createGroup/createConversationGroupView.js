...
class CreateConversationGroupView extends BaseView {
    ...
    constructor(props) {
        ...
        this.filter = {
            ...
            branchId: null,
            companyId: null,
            userType: userType.NORMAL_USERS
        };
        this.listFriends = [];
        this.listInvite = [];
                    ...
                    <View
                        style={{
                            ...
                            {this.renderCommonButton(
                                ...
                                () => this.validate(),
                                this.state.isDisableButtonInvite ? ['gray', 'gray'] : null,
                                this.state.isDisableButtonInvite ? true : false,
                            )}
                    </View>
    ...
    renderHeaderFlatList = () => {
        ...
        return (
            ...
            {/* text offer */}
            <Text style={[commonStyles.textBold, {margin: Constants.MARGIN_X_LARGE }]} >ĐƯỢC ĐỀ XUẤT</Text>
            </View>
        )
    }
    ...
    renderItemRow = (item, index, parentIndex, indexInParent) => {
        return (
            <ItemFriend
                key={index}
                item={item}
                type={screenType.FROM_CREATE_CHAT_GROUP}
                index={index}
    ...
    onClickItemUser = (item, index) => { 
        ...
        console.log("Nero list invite: ", this.listInvite);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateConversationGroupView)