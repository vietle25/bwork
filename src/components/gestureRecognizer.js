...
class GestureRecognizer extends Component {
  ...
  constructor(props, context) {
    ...
    this.allowChild = props.allowChild? props.allowChild: false
  }
  ...
  componentWillMount() {
    ...
    const moveResponse = this.moveResponse.bind(this);
    this._panResponder = PanResponder.create({ //stop JS beautify collapse
      onStartShouldSetPanResponder: shouldSetResponder,
      onMoveShouldSetPanResponder: moveResponse,
