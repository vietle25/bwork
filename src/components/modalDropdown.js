  ...
  _renderButton() {
    ...
    return (
      <TouchableOpacity
        ...
        <View ref={(ref) => (this.refButtonText = ref)} style={{flex: 1}}>
          {this.props.renderButtonView ? (
            this.props.renderButtonView(buttonText)
          ) : (
            <View style={styles.button}>
              <Text
                style={[styles.buttonText, commonStyles.text, textStyle]}
                numberOfLines={1}>
                {buttonText}
              </Text>
              <Icon
